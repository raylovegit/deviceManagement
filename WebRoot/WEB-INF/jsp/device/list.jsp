          ...
          <td valign="top">
            ...
            <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
                ...
                <c:forEach items="${nlist}" var="n" varStatus="s">
					...
					<td>${n.useOfYear}</td>
					<td>${n.stockDate}</td>
					<td><a href="${ctx}/deviceAction_preUpdate.action?pageNow=${pageNow}&id=${n.id}">编辑</a></td>
					<td><a href="${ctx}/deviceAction_delete.action?pageNow=${pageNow}&device.id=${n.id}" onclick="if(!confirm('确定要删除吗？')) return false;">删除</a></td>
					</tr>
				</c:forEach>
                ...
                <td colspan="4">
                   ...
                   <a id="pre" href="${ctx}/deviceAction_list.action?pageNow=${pageNow-1}" class="coolbg">上一页</a>
                   <a id="next" href="${ctx}/deviceAction_list.action?pageNow=${pageNow+1}" class="coolbg">下一页</a>
                </td>
                </tr>
